...
for /f "tokens=1,3,5,7,9delims='" %%A in ('python "D:\Téléchargements\Python Stuff\IS.bookmarks\bookmarks_parser.py" -e --folders-path --quoting-style "'" "D:\Git\Illegal_Services\IS.bookmarks.html"') do (
    if not "%%B"=="" (
        if "%%A_%%B"=="PATH_0" (
